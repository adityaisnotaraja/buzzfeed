const QuestionsLog = [
    ...
    { question: "It's Saturday night! What does the playlist look like?!", options: ["Farida Khannun on loop", "Spotify's Pop All Day playlist", "Ben Platt, Adele, All Too Well (10 Min Ver)", "Whatever's playing on Discord"], results: [0, 2, 1, 3] },
    ...
    { question: "What do you think of Memory of Light", options: ["A lyrical romance", "A superficial ghazal", "A vain romanticisation of love", "It fucking sucks"], results: [2, 2, 2, Math.floor(Math.random() * 4)] }
];
